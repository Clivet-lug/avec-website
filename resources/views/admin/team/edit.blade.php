                            ...
                            <div id="photo-preview" class="w-28 h-28 rounded-full overflow-hidden mb-3"
                                ...
                                @else
                                    <div class="w-full h-full flex items-center justify-center"
                                        style="background:linear-gradient(135deg,rgba(0,217,255,0.08),rgba(155,143,245,0.08));">
                                        <span style="font-size:24px;font-weight:700;color:#00bcd4;">
                                            {{ substr($member->name, 0, 1) }}{{ substr(explode(' ', $member->name)[1] ?? '', 0, 1) }}
                                        </span>
                                    </div>
                                @endif
                            </div>
                            <label for="photo-input" style="font-size:12px;font-weight:600;color:#00bcd4;cursor:pointer;">
                                {{ $member->photo ? 'Replace photo' : 'Choose photo' }}
                            </label>
                        </div>
